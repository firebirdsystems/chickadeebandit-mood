...
CREATE TABLE IF NOT EXISTS app_mood__entries (
  id           TEXT    NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS entries_unique_day
  ON app_mood__entries (member_id, entry_date);
...
CREATE TABLE IF NOT EXISTS app_mood__shares (
  id           TEXT NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS shares_unique_pair
  ON app_mood__shares (owner_id, viewer_id);

CREATE INDEX IF NOT EXISTS shares_viewer_idx
  ON app_mood__shares (viewer_id);
